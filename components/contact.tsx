  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Show different toast message for preview environments
        if (result.preview) {
          toast({
            title: "Message received (Preview Mode)",
            description: "In the live site, this message would be sent to your email.",
          })
        } else {
          toast({
            title: "Message sent!",
